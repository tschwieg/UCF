...
print( "m = Model( solver = SCIPSolver() )")
...
for i in range(N):
	for j in range(N):
		...
		print( "@variable( m, IX" + format( i,'02') + format( j, '02' ) + ", Bin )" )
		print( "@variable( m, IY" + format( i,'02') + format( j, '02' ) + ", Bin )" )
		print( "@variable( m, MX" + format( i,'02') + format( j, '02' ) + ", Bin )" )
		print( "@variable( m, MY" + format( i,'02') + format( j, '02' ) + ", Bin )" )
for i in range( 1,N ):
...
for i in range(1,N):
	for j in range(1,N):
		if( i == j ):
			continue
		print( "@constraint( m, X00" + format( i,'02') + " + X" + format( j, '02' ) + "00 - IX" + format( i,'02') + format( j, '02' ) + " - MX"  + format( i,'02') + format( j, '02' ) + " == 0)" )
		print( "@constraint( m, Y00" + format( i,'02') + " + Y" + format( j, '02' ) + "00 - IY" + format( i,'02') + format( j, '02' ) + " - MY"  + format( i,'02') + format( j, '02' ) + " == 0 )" )
...
for i in range(1,N):
	for j in range(1,N):
		if( i == j ):
			continue
		text += "IX"  + format( i,'02') + format( j, '02' ) + " + "
text += "0 == 1 )"
print( text )
...
for i in range(1,N):
	for j in range(1,N):
		if( i == j ):
			continue
		text += "IY"  + format( i,'02') + format( j, '02' ) + " + "
text += "0 == 1 )"
print( text )
...
for i in range(1,N):		
	...
	for j in range(1,N):
		if( i == j ):
			continue
		text += str( averageDemand[j] ) + "*X"+ format( i,'02')+ format( j,'02') + " + "
	#text += "0 ) /2400 ) + "
...
for i in range(1,N):		
	...
	for j in range(1,N):
		if( i == j ):
			continue
		text += str( averageDemand[j] ) + "*Y"+ format( i,'02')+ format( j,'02') + " + "
	#text += "0 ) /2400 ) + "
text += " S)"
print( text )
...
for i in range(1,N):		
	for j in range(1,N):
		if( i == j ):
			continue
		text += str( C[i,j] ) + "*( X" + format( i,'02') + format( j, '02' ) + "+ Y" + format( i,'02') + format( j, '02' ) + " + IX" + format( i,'02') + format( j, '02' ) + " + IY" + format( i,'02') + format( j, '02' ) + ")+ "
text += "0 )"
print( text )
...
for i in range(N):		
	for j in range(N):
		if( i == j ):
			continue
		print( "println(\"IX" + format( i,'02') + format( j, '02' ) + ":\", getvalue(IX"  + format( i,'02') + format( j, '02' ) + "))")

for i in range(N):	
	for j in range(N):
		if( i == j ):
			continue
		print( "println(\"IY" + format( i,'02') + format( j, '02' ) + ":\", getvalue(IY"  + format( i,'02') + format( j, '02' ) + "))")
