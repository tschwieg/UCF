...
for i in range(1,N):		
	...
	for j in range(N):
		if( i == j ):
			continue
		text += str( np.ceil((averageDemand[i]*1000)/(1200*50)) ) + "*X"+ format( i,'02')+ format( j,'02') + " + "
	#text += "0 ) /2400 ) + "
...
for i in range(1,N):		
	...
	for j in range(N):
		if( i == j ):
			continue
		text += str( np.ceil((averageDemand[i]*1000)/(1200*50)) ) + "*Y"+ format( i,'02')+ format( j,'02') + " + "
	#text += "0 ) /2400 ) + "
text += " 0)"
print( text )
...
for i in range(1,N):		
	for j in range(1,N):
		if( i == j ):
			continue
		text += str( C[i,j] ) + "*( X" + format( i,'02') + format( j, '02' ) + "+ Y" + format( i,'02') + format( j, '02' ) + " )+ "
text += "0 )"
print( text )
